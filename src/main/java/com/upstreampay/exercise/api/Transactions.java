...
public class Transactions {
    ...
    @PutMapping()
    public ResponseEntity<Transaction> updateTransaction(@RequestBody TransactionDto transactionDto) throws UpdateTransactionException, NotFoundException, StatusTransactionException {
